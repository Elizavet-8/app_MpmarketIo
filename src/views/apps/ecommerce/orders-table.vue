          ...
          <form action="#" id="addform">
            <div class="modal-body">
              ...
              <div class="row gy-4 mb-3">
                <div class="col-md-6">
                  <div>
                    <label for="color-field" class="form-label">Цвет</label>
                    <select class="form-control" data-trigger name="color-field" id="color-field">
                ...
                <div class="col-md-6">
                  <div>
                    <label for="size-field" class="form-label">Размер</label>
                    <select class="form-control" data-trigger name="size-field" id="size-field">
              ...
              <div class="row gy-4 mb-3">
                <div class="col-md-6">
                  <div>
                    <label for="shtrih-field" class="form-label">Штрихкод</label>
                    <input type="text" id="shtrih-field" class="form-control" placeholder="Штрихкод" required/>
                  </div>
                </div>
                <div class="col-md-6">
                  <div>
